...
const Movierow3 = () => {
  ...
  window.addEventListener("scroll", function () {
    var element: any = document.getElementById("CollectionFilms");
  ...
  return (
    <div>
      <div className="w-full h-100 mb-8 overflow-x-hidden sm:mt-[-45px]">
        <h1 className="raleway text-2xl font-semibold text-center mt-1 pt-24 font-sans sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl 2xl:text-4xl sm:mt-[-3%]" id="CollectionFilms">
          COLLECTION
        </h1>
