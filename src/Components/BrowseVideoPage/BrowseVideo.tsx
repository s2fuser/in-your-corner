...
const TopicButton: React.FC<ButtonProps> = ({ label, func }) => {
  ...
  return (
    <button
      className="border-solid rounded-3xl border-2 hover:text-red-600 hover:border-white hover:bg-slate-100 bg-transparent text-white border-2 border-white rounded-[25px] px-8 py-2 m-4 cursor-pointer font-bold sm:block sm:ml-[-25px]"
      onClick={func}
    >
      {label}
    </button>
