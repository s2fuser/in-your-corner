...
const FirstPageComponent = () => {
  return (
    <div
      className="h-screen relative sm:h-[500px]"
      style={{
        backgroundImage: "linear-gradient(190deg, red 50%, transparent 80%)",
      }}
    >
      <div className="pt-32 pl-20 sm:ml-[-45px]">
        <div className="sm:mt-[-45px]">
          <p className="text-white text-3xl font-light font-sans">featuring</p>
          <p className="text-white text-3xl font-medium font-sans">
            the testimonies of
          </p>
          <p className="text-white text-3xl font-light font-sans">
            men and women{" "}
            <span className="text-white text-3xl font-medium font-sans">
              of faith
            </span>
          </p>
        </div>
      ...
      <div className="relative mt-36">
        ...
        <div className="text-center mt-80 sm:mt-[170px] sm:pt-[20px] sm:pl-[10px] sm:pr-[10px]">
          ...
          <p className="text-sm font-sans">
            ...
            acclaimed documentaries, gospel music, and ministry videos to help
            promote other faith-based non-profits.
          </p>
        </div>
      </div>
          ...
          <div className=" bg-pink-100 pt-40 h-5/6">
            <div className="flex justify-center py-8 px-2 sm:mb-[-50px]">
              <iframe
                width="720"
                height="365"
                src="https://www.youtube.com/embed/tWYsfOSY9vY?si=BS2cklqv3dV9wM8y"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowFullScreen
                className="mt-[-300px] rounded-[20px] lg:w-[900px] lg:h-[450px] h-[220px] w-[500px] md:h-[260px]"
              ></iframe>
            </div>
            ...
            <div className="text-center mt-[150px] text-lg pb-24 sm:mt-[200px]">
              <Link to="/Videos">
                <button className="text-red-900 px-14 py-2.5 border border-2 border-red-900 rounded-3xl font-sans">
                  View All Videos
                </button>
              </Link>
            </div>
            <div className="text-center pb-40 font-sans">
              <p className="text-red-900 text-4xl font-light mb-7 font-sans">
                ...
                <span className="text-red-900 text-4xl font-semibold font-sans">
                  Jesus Christ
                </span>
              </p>
              <p className="font-sans sm:pl-[10px] sm:pr-[10px] lg:w-[800px] lg:ml-[280px]">
                ...
                impact by creating compelling documentary films. Among them are
                the award-winning “Hope Lives in Hohenwald” and “Fight the Good
                Fight,” a documentary highlighting champion boxers who
                discovered hope in Jesus Christ.
              </p>
            </div>
          </div>
        </div>
