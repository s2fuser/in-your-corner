...
const Mainheading = () => {
    return (
        ...
        <div className=' bg-gradient-to-r from-red-100 via-indigo-100 to-indigo-200 w-full  sm:h-[339px] lg:h-[319px] font-sans mt-[7px] '>
            <div className='relative '>
                <img src={BackgroundImage3} alt='' className='sm:h-[130px] sm:w-full  sm:overflow-x-hidden  lg:h-[304px] lg:w-full  lg:overflow-x-hidden mt-[-7px]' />
                <h1 className='  absolute font-semibold font-sans   text-center left-0 right-0 text-4xl  sm:text-center sm:left-0 sm:right-0 lg:top-[32px] top-[10px] md:top-[15px] sm:top-[18px]  md:left-0 md:right-0 md:text-center sm:text-2xl md:text-2xl' >    
                    WELCOME TO OUR VIDEO LIBRARY
                </h1>

                <h3 className="absolute text-red-600 text-xl text-center left-0 right-0 sm:text-center sm:left-0 sm:right-0 lg:top-[99px] top-[71px] sm:mt-[90px] md:left-0 md:right-0 md:text-center sm:text-xl md:text-2xl">
                    A free streaming library of over 150 films <br /> featuring the real stories of real people who met the real Jesus.
                </h3>
            </div>
                <div>
                 ...
                 <h1 className=' lg:h-[60px] md:text-2xl font-semibold text-center text-4xl sm:text-2xl  font-sans text-slate-950 sm:mt-[172px] md:mt-[-25px]  lg:mt-[-38px] xl:mt-[-40px]  ' >
                    FEATURED FILMS
                </h1> 
