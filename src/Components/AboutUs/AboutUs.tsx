...
const AboutUsComponent = () => {
  ...
  return (
    ...
    <div className="sm:px-[10px] sm:h-[100%] bg-gradient-to-l from-pink-100 to-pink-200 overflow-x-hidden ">
      ...
      <div className="lg:flex lg:justify-center mx-8 sm:block sm:mt-[260px] md:block md:mt-[250px] lg:mt-[0px] background-div" data-aos="fade-right" >
        <img
      ...
      <div className="mx-8 py-12 sm:block" data-aos="flip-left">
      ...
      <div className="mx-8 py-12 sm:block">
        <p className="raleway sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl 2xl:text-4xl font-sans text-center mb-[30px]"  data-aos="zoom-in">
    ...
    // <div className=" bg-gradient-to-l from-pink-100 to-pink-200">
    //   <div className="lg:flex lg:justify-center mx-8 py-12 sm:block md:block pt-[60px] pb-[60px] " >
    //   <div className="lg:px-[50px] sm:w-[100%]" data-aos="fade-right" >
    //     <p className="raleway sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl 2xl:text-4xl font-sans mb-[60px]">
    //       In Your Corner Ministries
    //     </p>
