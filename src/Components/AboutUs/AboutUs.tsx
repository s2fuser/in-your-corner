        ...
        <div className="sm:px-[10px] sm:h-[100%]">
            <div className="lg:flex lg:justify-center mx-8 my-12 sm:block md:block">
                ...
                <div className="mt-[40px] h-[200px] sm:mb-[50px]">
                    <img src={Image4} alt="" className="md:mx-auto md:mt-[30px] md:h-[400px] md:max-w-[400px] lg:h-[400px] lg:max-w-[400px] xl:h-[400px] xl:max-w-[400px] 3xl:h-[600px] 3xl:max-w-[500px]" />
                </div>
            </div>
            <div className="lg:flex lg:justify-center mx-8 my-12 sm:block sm:mt-[260px] md:block md:mt-[250px] lg:mt-[0px]">
                <img className="md:mx-auto lg:h-[400px] lg:ml-[100px] sm:h-[280px] sm:w-[292px] sm:mb-[30px] md:h-[200px] sm:mx-auto md:mb-[30px] md:w-[500px] md:h-[400px]" src={Image3} alt="" />
            ...
            <div className="mx-8 my-12 sm:block">
                ...
                <iframe width="560" height="315" className="mx-auto sm:w-[300px] sm:h-[200px] sm:mb-[70px] 2xl:w-[800px] 2xl:h-[500px]" src="https://www.youtube.com/embed/RZduf4KA6Bs?si=kOiyhfRRo36O0geQ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
