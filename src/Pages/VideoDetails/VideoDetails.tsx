...
const VideoDetailsPage = () => {
    ...
    const getLogInEmailLocal = () => {
        ...
        if (iframe) {
            ...
            iframe.classList.add('w-[100%]', 'h-44', 'lg:w-[800px]', 'lg:h-[450px]', 'xl:w-[900px]' , '2xl:w-[1000px]' , '2xl:h-[500px]' , '3xl:w-[800px]' , '3xl:h-[450px]', 'md:h-[300px]'); // Add Tailwind CSS classes for width and height
        }
    }
    ...
    return (
        ...
        <div>
            ...
            <div className="text-center pt-10 pb-4">
                <h2 className="font-bold text-4xl font-nunito">{title}</h2>
            </div>

            <div className="px-2">
                <p className="text-center text-lg text-red-900 font-semibold pb-3">
