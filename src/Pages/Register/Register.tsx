  ...
  return (
    <div>
      ...
      <div className="text-center mb-[40px]">
        <button
          className="raleway border border-solid border-red-900 border-2 pt-[5px] pb-[5px] pl-[20px] pr-[20px] rounded-[25px] text-red-900 text-lg"
          onClick={SubmittingRegister}
        >
          Register
        </button>
      </div>
